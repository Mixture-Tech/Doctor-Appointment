...
public interface AppointmentRepository extends JpaRepository<Appointment, String> {
    ...
    @Query("SELECT new mixture.hutech.backend.dto.response.AppointmentResponse(a.probableStartTime,a.actualEndTime,a.appointmentTakenDate,a.doctorSchedule.user.username,a.appointmentStatus,a.createdAt) FROM Appointment a WHERE a.user.email = :userId")
